-- Migration 040: Fix complete_top8 function with better error handling
-- This migration improves the complete_top8 function to handle edge cases and provide better error messages

-- Drop and recreate the complete_top8 function with better error handling
