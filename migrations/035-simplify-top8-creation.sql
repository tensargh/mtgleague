-- Migration 035: Simplify Top 8 creation - let frontend handle seeding
-- This migration simplifies the create_top8_for_season function to just create empty matches

-- Drop and recreate the create_top8_for_season function to just create empty matches
...
BEGIN
    ...
    -- Create Semi Finals (4 matches) - empty, will be filled manually
    INSERT INTO top8_matches (top8_id, round, ordinal) VALUES
        (v_top8_id, 'sf', 1),
        (v_top8_id, 'sf', 2),
        (v_top8_id, 'sf', 3),
    ...
    RAISE NOTICE 'Created 9 empty matches (4 QF + 4 SF + 1 Final)';
